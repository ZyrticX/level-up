...
// Mock course data - Purchased version
const courseData = {
  'physics-101': {
    ...
    chapters: [
      { 
        ...
        isCompleted: true,
        topics: [
          { name: 'מבוא כללי', duration: '00:45:30', watched: true },
          { name: 'יחידות מידה', duration: '01:12:00', watched: true },
          { name: 'וקטורים', duration: '01:35:45', watched: true },
          { name: 'תרגילים', duration: '01:59:00', watched: true }
        ]
      },
      { 
        ...
        isCompleted: false,
        topics: [
          { name: 'תנועה חד ממדית', duration: '01:30:00', watched: true },
          { name: 'תנועה דו ממדית', duration: '02:00:00', watched: true },
          { name: 'תנועה מעגלית', duration: '01:45:30', watched: false },
          { name: 'דוגמאות', duration: '01:00:00', watched: false }
        ]
      },
      { 
        ...
        isCompleted: false,
        topics: [
          { name: 'חוק ניוטון הראשון', duration: '01:15:00', watched: false },
          { name: 'חוק ניוטון השני', duration: '02:30:20', watched: false },
          { name: 'חוק ניוטון השלישי', duration: '01:45:00', watched: false },
          { name: 'יישומים', duration: '02:15:00', watched: false }
        ]
      },
      { 
        ...
        isCompleted: false,
        topics: [
          { name: 'מושג העבודה', duration: '01:20:00', watched: false },
          { name: 'אנרגיה קינטית', duration: '01:35:15', watched: false },
          { name: 'אנרגיה פוטנציאלית', duration: '01:40:30', watched: false },
          { name: 'שימור אנרגיה', duration: '01:20:00', watched: false }
        ]
      },
      { 
        ...
        isCompleted: false,
        topics: [
          { name: 'מושג התנע', duration: '01:30:00', watched: false },
          { name: 'שימור תנע', duration: '02:00:10', watched: false },
          { name: 'התנגשויות', duration: '02:00:00', watched: false },
          { name: 'תרגילים', duration: '01:00:00', watched: false }
        ]
      },
      { 
        ...
        isCompleted: false,
        topics: [
          { name: 'קינמטיקה סיבובית', duration: '01:45:00', watched: false },
          { name: 'דינמיקה סיבובית', duration: '02:15:35', watched: false },
          { name: 'תנע זוויתי', duration: '01:20:00', watched: false }
        ]
      },
      { 
        ...
        isCompleted: false,
        topics: [
          { name: 'חוק הכבידה', duration: '01:30:00', watched: false },
          { name: 'תנועת כוכבי לכת', duration: '02:00:20', watched: false },
          { name: 'שדה כבידה', duration: '01:15:00', watched: false }
        ]
      },
      { 
        title: 'פרק 8 - תנודות', 
        ...
        isCompleted: false,
        topics: [
          { name: 'תנועה הרמונית פשוטה', duration: '02:00:00', watched: false },
          { name: 'מטוטלת', duration: '01:30:25', watched: false },
          { name: 'תנועות מרוסנות', duration: '01:40:00', watched: false }
        ]
      }
    ],
    studyMaterials: {
...
const CoursePagePurchased = () => {
  const { courseId } = useParams<{ courseId: string }>();
  const [openFolder, setOpenFolder] = useState<string | null>(null);
  const [expandedChapters, setExpandedChapters] = useState<Set<number>>(new Set([0, 1])); // Open first 2 chapters
  ...
  const nextTopic = nextChapter?.topics.find(t => !t.watched);
  ...
  return (
    <div className="min-h-screen bg-background" dir="rtl">
      <main className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="bg-gradient-to-br from-white via-primary/5 to-primary/10 border-2 border-primary/20 rounded-3xl p-10 mb-8 shadow-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="flex items-center gap-3 text-foreground">
              ...
              <div>
                <div className="text-sm text-muted-foreground">סרטוני ווידאו</div>
                <div className="font-semibold">{course.stats.videos} סרטונים</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 text-foreground">
              ...
              <div>
                ...
                <div className="font-semibold">{course.stats.videosWatched}/{course.stats.videos}</div>
              </div>
            </div>
        ...
        {nextTopic && (
          <Link to={`/watch/${courseId}`}>
            <Button className="w-full bg-gradient-to-l from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-2xl p-8 mb-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 h-auto">
              <div className="flex items-center justify-center gap-6">
                <div className="w-20 h-20 bg-white/20 rounded-2xl flex items-center justify-center">
                  <PlayCircle className="w-10 h-10 text-white" />
                </div>
                <div className="text-right">
                  <div className="text-3xl font-bold mb-2">המשך לצפות</div>
                  <div className="text-xl font-medium opacity-90">
                    {nextChapter?.title} • {nextTopic.name}
                  </div>
                </div>
              </div>
            </Button>
                  ...
                  {course.chapters.map((chapter, index) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-between p-5 bg-muted/30 hover:bg-muted/50 transition-colors text-right"
                      >
                        ...
                        <div className="flex items-center gap-2 text-muted-foreground">
                          ...
                          {chapter.isCompleted && (
                            <Badge className="bg-green-500 mr-2">הושלם</Badge>
                          )}
                        </div>
                      </button>
                          ...
                          <div className="p-4 space-y-2">
                            {chapter.topics.map((topic, topicIndex) => (
                              ...
                              >
                                ...
                                <Link
                                  to={`/watch/${courseId}?chapter=${index}&topic=${topicIndex}`}
            ...
            <Card>
              <CardHeader className="space-y-4">
                ...
                <Button 
                  ...
                  onClick={() => alert('מוריד את כל הקבצים...')}
                >
...
export default CoursePagePurchased;
